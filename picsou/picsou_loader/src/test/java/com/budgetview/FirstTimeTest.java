...
public class FirstTimeTest extends UISpecTestCase {
  ...
  public void testLoad() throws Exception {
    ...
    transaction
      ...
      .add("01/10/2008", "Planned: Rent/Mortgage", -700.00, "Rent/Mortgage", 970.00, "Main accounts")
...
//      .close();
    ...
    transaction
      .showPlannedTransactions()
      .initAmountContent()
      .add("20/10/2008", "Planned: Health", 20.00, "Health", 2386.10, "Main accounts")
      .add("20/10/2008", "Planned: Income 1", 2000.00, "Income 1", 2366.10, "Main accounts")
      .add("19/10/2008", "Planned: Ecole", -40.00, "Ecole", 366.10, "Main accounts")
      .add("19/10/2008", "Planned: Frais banque", -4.00, "Frais banque", 406.10, "Main accounts")
...
//      .close();
    ...
    transaction
      .showPlannedTransactions()
      .initAmountContent()
      .add("20/11/2008", "Planned: Health", 20.00, "Health", 2902.20, "Main accounts")
      .add("20/11/2008", "Planned: Revenu", 2000.00, "Revenu", 2882.20, "Main accounts")
      .add("16/11/2008", "Planned: Regular savings", -100.00, "Regular savings", 882.20, "Main accounts")
      .add("16/11/2008", "Planned: Ecole", -40.00, "Ecole", 982.20, "Main accounts")
      .add("16/11/2008", "Planned: Assurance", -100.00, "Assurance", 1022.20, "Main accounts")
      .add("16/11/2008", "Planned: Cell phone 1", -40.00, "Cell phone 1", 1122.20, "Main accounts")
      .add("16/11/2008", "Planned: Cash", -40.00, "Cash", 1162.20, "Main accounts")
      .add("16/11/2008", "Planned: Gas", -60.00, "Gas", 1202.20, "Main accounts")
      .add("16/11/2008", "Planned: Leisures", -10.00, "Leisures", 1262.20, "Main accounts")
      .add("16/11/2008", "Planned: Internet", -29.90, "Internet", 1272.20, "Main accounts")
      .add("16/11/2008", "Planned: Don", -40.00, "Don", 1302.10, "Main accounts")
      .add("16/11/2008", "Planned: Mortgage", -700.00, "Mortgage", 1342.10, "Main accounts")
      .add("16/11/2008", "Planned: Groceries", -250.00, "Groceries", 2042.10, "Main accounts")
      .add("16/11/2008", "Planned: Fringue", -90.00, "Fringue", 2292.10, "Main accounts")
      .add("01/11/2008", "Planned: Frais banque", -4.00, "Frais banque", 2382.10, "Main accounts")
      .add("20/10/2008", "Planned: Health", 20.00, "Health", 2386.10, "Main accounts")
      .add("20/10/2008", "Planned: Revenu", 2000.00, "Revenu", 2366.10, "Main accounts")
      .add("19/10/2008", "Planned: Ecole", -40.00, "Ecole", 366.10, "Main accounts")
      .add("19/10/2008", "Planned: Frais banque", -4.00, "Frais banque", 406.10, "Main accounts")
      .add("19/10/2008", "Planned: Assurance", -100.00, "Assurance", 410.10, "Main accounts")
      .add("19/10/2008", "Planned: Cell phone 1", -40.00, "Cell phone 1", 510.10, "Main accounts")
...
//      .close();
    ...
    transaction
      .showPlannedTransactions()
      .initAmountContent()
      .add("20/11/2008", "Planned: Income 1", 2000.00, "Income 1", 2002.20, "Main accounts")
      .add("20/11/2008", "Planned: Health", 20.00, "Health", 2.20, "Main accounts")
      .add("16/11/2008", "Planned: Regular savings", -100.00, "Regular savings", -17.80, "Main accounts")
      .add("16/11/2008", "Planned: Ecole", -40.00, "Ecole", 82.20, "Main accounts")
      .add("16/11/2008", "Planned: Assurance", -100.00, "Assurance", 122.20, "Main accounts")
      .add("16/11/2008", "Planned: Cell phone 1", -40.00, "Cell phone 1", 222.20, "Main accounts")
      .add("16/11/2008", "Planned: Cash", -40.00, "Cash", 262.20, "Main accounts")
      .add("16/11/2008", "Planned: Gas", -60.00, "Gas", 302.20, "Main accounts")
      .add("16/11/2008", "Planned: impots", -400.00, "impots", 362.20, "Main accounts")
      .add("16/11/2008", "Planned: Leisures", -10.00, "Leisures", 762.20, "Main accounts")
      .add("16/11/2008", "Planned: Internet", -29.90, "Internet", 772.20, "Main accounts")
      .add("16/11/2008", "Planned: Don", -40.00, "Don", 802.10, "Main accounts")
      .add("16/11/2008", "Planned: Mortgage", -700.00, "Mortgage", 842.10, "Main accounts")
      .add("16/11/2008", "Planned: Groceries", -250.00, "Groceries", 1542.10, "Main accounts")
      .add("16/11/2008", "Planned: Fringue", -90.00, "Fringue", 1792.10, "Main accounts")
      .add("01/11/2008", "Planned: Frais banque", -4.00, "Frais banque", 1882.10, "Main accounts")
      .add("20/10/2008", "Planned: Income 1", 2000.00, "Income 1", 1886.10, "Main accounts")
      .add("20/10/2008", "Planned: Health", 20.00, "Health", -113.90, "Main accounts")
      .add("19/10/2008", "Planned: Regular savings", -100.00, "Regular savings", -133.90, "Main accounts")
      .add("19/10/2008", "Planned: Ecole", -40.00, "Ecole",-33.90, "Main accounts")
      .add("19/10/2008", "Planned: Frais banque", -4.00, "Frais banque", 6.10, "Main accounts")
      .add("19/10/2008", "Planned: Assurance", -100.00, "Assurance", 10.10, "Main accounts")
      .add("19/10/2008", "Planned: Cell phone 1", -40.00, "Cell phone 1", 110.10, "Main accounts")
      .add("19/10/2008", "Planned: Cash", -40.00, "Cash", 150.10, "Main accounts")
      .add("19/10/2008", "Planned: impots", -400.00, "impots", 190.10, "Main accounts")
      .add("19/10/2008", "Planned: Leisures", -10.00, "Leisures", 590.10, "Main accounts")
      .add("19/10/2008", "Planned: Groceries", -180.00, "Groceries", 600.10, "Main accounts")
      .add("19/10/2008", "GAZ DE FRANCE", -60.00, "Gas", 780.10, 780.10, OfxBuilder.DEFAULT_ACCOUNT_NAME)
      .add("11/10/2008", "AUCHAN", -30.00, "Groceries", 840.10, 840.10, OfxBuilder.DEFAULT_ACCOUNT_NAME)
