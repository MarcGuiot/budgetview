...
public class FirstTimeTest extends UISpecTestCase {
  ...
  public void testLoad() throws Exception {
    ...
    transaction.initAmountContent()
      ...
      .add("25/09/2008", "JEUX POUR TOUS", -25.00, "Occasionel", -60.00, -60.00, "Account n. 00001123")
      .add("23/09/2008", "COTISATION CARTE BLEUE", -4.00, "Frais banque", -35.00, -35.00, "Account n. 00001123")
      .add("22/09/2008", "COUP'COUP", -30.00, "Occasionel", -31.00, -31.00, "Account n. 00001123")
    ...
    transaction.initAmountContent()
      ...
      .add("03/10/2008", "Planned: Regular savings", -100.00, "Regular savings", 1800.00, 2590.10, "Account n. 00001123")
    ...
    transaction.initAmountContent()
      ...
      .add("19/10/2008", "Planned: Regular savings", -100.00, "Regular savings", 680.10, 1930.10, "Account n. 00001123")
      .add("19/10/2008", "Planned: Income 1", 2000.00, "Income 1", 2030.10, "Main accounts")
...
//    args.add("-D" + PicsouApplication.APPNAME + ".today=" + Dates.toString(currentDate));
  ...
  public void testReloadSnapshotV5() throws Exception {
    ...
    transaction.initAmountContent()
      ...
      .add("01/11/2008", "Planned: Regular savings", -100.00, "Regular savings", 680.10, 3076.20, "Account n. 00001123")
      .add("01/11/2008", "Planned: Health", 20.00, "Health", 3176.20, "Main accounts")
      .add("01/11/2008", "Planned: Revenu", 2000.00, "Revenu", 3156.20, "Main accounts")
      .add("01/11/2008", "Planned: Assurance", -100.00, "Assurance", 1156.20, "Main accounts")
      .add("01/11/2008", "Planned: Cell phone 1", -40.00, "Cell phone 1", 1256.20, "Main accounts")
      .add("01/11/2008", "Planned: Cash", -40.00, "Cash", 1296.20, "Main accounts")
      .add("01/11/2008", "Planned: Gas", -60.00, "Gas", 1336.20, "Main accounts")
      .add("01/11/2008", "Planned: Leisures", -10.00, "Leisures", 1396.20, "Main accounts")
      .add("01/11/2008", "Planned: Internet", -29.90, "Internet", 1406.20, "Main accounts")
      .add("01/11/2008", "Planned: Mortgage", -700.00, "Mortgage", 1436.10, "Main accounts")
      .add("01/11/2008", "Planned: Groceries", -250.00, "Groceries", 2136.10, "Main accounts")
      .add("28/10/2008", "Planned: Ecole", -40.00, "Ecole", 2386.10, "Main accounts")
      .add("23/10/2008", "Planned: Frais banque", -4.00, "Frais banque", 2426.10, "Main accounts")
      .add("19/10/2008", "Planned: Health", 20.00, "Health", 2430.10, "Main accounts")
      ...
      .add("25/09/2008", "JEUX POUR TOUS", -25.00, "To categorize", -60.00, -60.00, "Account n. 00001123")
      .add("23/09/2008", "COTISATION CARTE BLEUE", -4.00, "Frais banque", -35.00, -35.00, "Account n. 00001123")
      .add("22/09/2008", "COUP'COUP", -30.00, "To categorize", -31.00, -31.00, "Account n. 00001123")
      .add("22/09/2008", "GMF", -100.00, "Assurance", -1.00, -1.00, "Account n. 00001123")
      .add("22/09/2008", "INTERMARCHÉ", -150.00, "Groceries", 99.00, 99.00, "Account n. 00001123")
      .add("21/09/2008", "SFR", -40.00, "Cell phone 1", 249.00, 249.00, "Account n. 00001123")
      .add("20/09/2008", "RETRAIT", -40.00, "Cash", 289.00, 289.00, "Account n. 00001123")
  ...
  public void testReloadSnapshotV20() throws Exception {
    ...
    transaction.initAmountContent()
      ...
      .add("03/11/2008", "Planned: Regular savings", -100.00, "Regular savings", 580.10, 2576.20, "Account n. 00001123")
