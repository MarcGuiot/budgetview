...
import org.designup.picsou.gui.analysis.components.SeriesAnalysisBreadcrumb;
...
public class AnalysisView extends View {
  ...
  public AnalysisView(GlobRepository repository, Directory directory, PrintBudgetAction printBudgetAction) {
