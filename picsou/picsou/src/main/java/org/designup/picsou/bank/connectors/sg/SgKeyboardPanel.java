...
import org.designup.picsou.bank.connectors.webcomponents.WebTextField;
...
class SgKeyboardPanel extends JPanel {
  ...
  public void setImage(BufferedImage clavier, WebMap map, WebTextField password, WebPanel zoneClavier) throws WebParsingError {
    this.image = clavier;
