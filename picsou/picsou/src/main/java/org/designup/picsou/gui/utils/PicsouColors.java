...
public enum PicsouColors {
  ...
  PERIOD_TEXT,
  PERIOD_TEXT_SHADOW,
  PERIOD_PAST_SELECTION_BG_TOP,
  PERIOD_PAST_SELECTION_BG_BOTTOM,
  PERIOD_FUTURE_SELECTION_BG_TOP,
  PERIOD_FUTURE_SELECTION_BG_BOTTOM,
  PERIOD_CURRENT_SELECTION_BG_TOP,
  PERIOD_CURRENT_SELECTION_BG_BOTTOM,
  PERIOD_YEAR_SELECTION_BG_TOP,
  PERIOD_YEAR_SELECTION_BG_BOTTOM,
