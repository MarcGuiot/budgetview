...
public class HistoChartDemo {
  public static void main(String... args) {
    ...
    dataset.add(200801, 3500, 3000, "D", false, false);
    dataset.add(200802, 3800, 3900, "J", false, false);
    dataset.add(200803, 3300, 3000, "F", false, false);
    dataset.add(200804, 3300, 3300, "M", false, false);
    dataset.add(200805, 3700, 4200, "A", false, false);
    dataset.add(200806, 3500, 3000, "M", false, false);
    dataset.add(200807, 6000, 3200, "J", false, false);
    dataset.add(200808, 2100, 3000, "J", true, false);
    dataset.add(200809, 3600, 3000, "A", false, true);
    dataset.add(200810, 3700, 3400, "S", false, true);
    dataset.add(200811, 3800, 3500, "O", false, true);
    dataset.add(200812, 3900, 3000, "N", false, true);
    dataset.add(200901, 2000, 3000, "D", false, true);
