...
public class HistoChartDemo {
  public static void main(String... args) {
    ...
    dataset.add(200801, 3500, 3000, "D", "tooltip", "2008", false, false);
    dataset.add(200802, 3800, 3900, "J", "tooltip", "2009", false, false);
    dataset.add(200803, 3300, 3000, "F", "tooltip", "2009", false, false);
    dataset.add(200804, 3300, 3300, "M", "tooltip", "2009", false, false);
    ...
    dataset.add(200901, 2000, 3300, "D", "tooltip", "2009", false, true);
    dataset.add(200901, 2300, 3200, "J", "tooltip", "2010", false, true);
    dataset.add(200901, 2800, 3100, "F", "tooltip", "2010", false, true);
    dataset.add(200901, 3400, 3000, "M", "tooltip", "2010", false, true);
