...
public class CaisseEpargneTest extends SpecificBankTestCase {
  public void test() throws Exception {
    operations.importQifFile(10.0, getFile("caisse_epargne.qif"), "Caisse d'épargne");
    ...
    transactions
      ...
      .add("05/09/2008", TransactionType.VIREMENT, "C.A.F DE L'ESSONNE P 7246098DWEULERSSE   082008ME", "", 1111.11)
      .add("05/09/2008", TransactionType.PRELEVEMENT, "ECH PRET 0160302 DATE 20080905", "", -665.73)
      .add("05/09/2008", TransactionType.PRELEVEMENT, "ECH PRET 0160301 DATE 20080905", "", -111.11)
      .add("05/09/2008", TransactionType.PRELEVEMENT, "ECH PRET 0187126 DATE 20080905", "", -222.22)
      ...
      .add("20/08/2008", TransactionType.PRELEVEMENT, "CARTE CHAMPION 7926MG     180808", "", -123.21)
      .add("20/08/2008", TransactionType.PRELEVEMENT, "CARTE INTERMARCHE S/S     170808", "", -45.16)
      .add("20/08/2008", TransactionType.VIREMENT, "REMISE CHEQUE DIRECT REMISE N?:1037870-000003 CHEQUE", "", 123.12)
      .check();
  }
}
