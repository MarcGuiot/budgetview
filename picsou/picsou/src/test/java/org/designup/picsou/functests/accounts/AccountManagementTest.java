...
public class AccountManagementTest extends LoggedInFunctionalTestCase {
  ...
  public void testAccountsAreUpdatedDuringSubsequentImports() throws Exception {
    ...
    timeline.selectAll();
    transactions.initAmountContent()
      .add("20/01/2006", "BAR", -6.00, "To categorize", -9.00, -9.00, "Account n. 123123123")
      .add("17/01/2006", "FOO", -3.00, "To categorize", -3.00, -3.00, "Account n. 123123123")
  ...
  public void testCharts() throws Exception {
    ...
    mainAccounts.checkChartHidden("Account n. 111");
    mainAccounts.toggleChart("Account n. 111");
  ...
  public void testChartsAreHiddenByDefault() throws Exception {
