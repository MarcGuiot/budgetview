...
public class SeriesBudgetUpdateTransactionTriggerTest extends PicsouTriggerTestCase {
  ...
  public void testChangeSeriesBudgetAmountCreatePlannedTransaction() throws Exception {
    ...
    listener.assertLastChangesEqual(
      ...
      "        _category='2' _day='25' _label='Planned: course' _month='200808' _planned='true' _mirror='false'" +
      "        _series='101' _transactionType='5' id='0' type='transaction' _createdBySeries='false'/>\n" +
  ...
  public void testChangeAmountWithIncom() throws Exception {
    ...
    listener.assertLastChangesEqual(
      ...
      "        planned='false' series='102' type='transaction' category='0' mirror='false' createdBySeries='false'/>");
    ...
    listener.assertLastChangesEqual(
      ...
      "      _series='102' _transactionType='1' id='0' type='transaction' _mirror='false' _createdBySeries='false'/>" +
      "");
    listener.assertLastChangesEqual(
      SeriesBudget.TYPE,
