...
public class HistoChartMetricsTest extends ChartTestCase {
  ...
  public void testColumns() throws Exception {
    ...
    HistoChartMetrics metrics =
      new HistoChartMetrics(180, 135, getFontMetrics(), 10, 1000, 3000, true, false, false);
  ...
  public void testVerticalPositions() throws Exception {
    ...
    HistoChartMetrics metrics =
      new HistoChartMetrics(180, 140, getFontMetrics(), 10, 1000, 3000, true, false, false);
  ...
  public void testVerticalPositionsWithNoNegativeValues() throws Exception {
    HistoChartMetrics metrics =
      new HistoChartMetrics(180, 145, getFontMetrics(), 10, 0, 100, true, false, false);
  ...
  public void testColumnAt() throws Exception {
    HistoChartMetrics metrics =
      new HistoChartMetrics(150, 145, getFontMetrics(), 10, 0, 100, true, false, false);
  ...
  private void checkScaleValues(int panelHeight, int maxNegative, int maxPositive, double[] expected) {
    HistoChartMetrics metrics =
      new HistoChartMetrics(200, panelHeight, getFontMetrics(), 10, maxNegative, maxPositive, false, true, false);
