...
public class TransactionPlannedTriggerTest extends PicsouTriggerTestCase {
  ...
  public void testMonthChange() throws Exception {
    ...
    listener.assertLastChangesEqual(
      Transaction.TYPE,
      "<create account='-1' amount='-29.9' bankDay='18' bankMonth='200809' mirror='false' reconciled='false'" +
      ...
      "<create account='-1' amount='-29.9' bankDay='18' bankMonth='200808' mirror='false' reconciled='false'" +
    ...
    listener.assertLastChangesEqual(
      ...
      "          _day='18' _label='free telecom' _month='200808' _planned='true' _reconciled='false'" +
    ...
    listener.assertLastChangesEqual(
      ...
      "          _day='18' _label='free telecom' _month='200809' _planned='true' _reconciled='false'" +
  ...
  public void testEnvelopeSeriesChangeWithIncome() throws Exception {
    ...
    listener.assertLastChangesEqual(
      ...
      "          positionDay='18' positionMonth='200808' budgetDay='18' budgetMonth='200808' reconciled='false'" +
      ...
      "          positionDay='18' positionMonth='200809' budgetDay='18' budgetMonth='200809' reconciled='false'" +
  ...
  public void testOverrunEnveloppe() throws Exception {
    ...
    listener.assertLastChangesEqual(
      ...
      "          positionMonth='200808' positionDay='18' reconciled='false'" +
    ...
    listener.assertLastChangesEqual(
      ...
      "          _day='18' _label='courses' _month='200808' _planned='true' _reconciled='false'" +
      "          _budgetDay='18' _budgetMonth='200808' _positionDay='18' _positionMonth='200808' " +
  ...
  public void testOverrunIncome() throws Exception {
    ...
    listener.assertLastChangesEqual(
      ...
      "          day='18' id='" + transaction[0] + "' label='salaire' month='200808' reconciled='false'" +
      "          planned='true' series='102' transactionType='1' type='transaction' createdBySeries='false'/>");
    ...
    listener.assertLastChangesEqual(
      ...
      "          _day='18' _label='salaire' _month='200808' _planned='true' _reconciled='false'" +
