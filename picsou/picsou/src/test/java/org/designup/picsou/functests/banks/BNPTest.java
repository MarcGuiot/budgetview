...
public class BNPTest extends SpecificBankTestCase {
  ...
  private void checkFile(String path) throws IOException {
    ...
    transactions
      ...
      .add("03/06/2008", TransactionType.INTERNAL_TRANSFER, "VIR. VTL 03/06 12H13 V06031213 75315 4698764 3", "", 45.00)
      ...
      .add("20/05/2008", TransactionType.VIREMENT, "SECU 05/2008", "", 45.00)
      .add("16/05/2008", TransactionType.PRELEVEMENT, "TRESOR PUBLIC 75 IMPOT NUM 005002 ECH 16", "", -20.50)
      .add("15/05/2008", TransactionType.INTERNAL_TRANSFER, "VIR. SUR LE CODEVI 300044687354357421340", "", -20.50)
      .add("15/05/2008", TransactionType.INTERNAL_TRANSFER, "VIR. SUR LE P.E.L 300040123454643353", "", -20.50)
