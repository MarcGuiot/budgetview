...
public class FortisTest extends SpecificBankTestCase {
  ...
  public void test() throws Exception {
    ...
    transactions
      ...
      .add("03/12/2009", TransactionType.PRELEVEMENT, "VIREMENT AU COMPTE DE SCARLET DE CHEZ TRUC", "", -55.55)
      ...
      .add("02/12/2009", TransactionType.PRELEVEMENT, "VIREMENT AU COMPTE DE SCARLET VIA PC BANKING  COMMUNICATION:  953101296156", "", -55.55)
