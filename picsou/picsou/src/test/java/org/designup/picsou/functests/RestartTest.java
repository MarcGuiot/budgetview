...
public class RestartTest extends LoggedInFunctionalTestCase {
  ...
  public void testSeries() throws Exception {
    ...
    transactions
      ...
      .initContent()
      .add("15/09/2008", TransactionType.PLANNED, "Planned: Salary", "", 1000.00, "Salary")
  ...
  public void testRestartAfterCurrentMonthChanged() throws Exception {
    ...
    transactions
      .showPlannedTransactions()
      .initContent()
      .add("15/10/2008", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
      ...
      .add("15/09/2008", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
    ...
    transactions
      .showPlannedTransactions()
      .initContent()
      .add("15/11/2008", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
    ...
    transactions
      .showPlannedTransactions()
      .initContent()
      .add("15/12/2008", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
    ...
    transactions
      .showPlannedTransactions()
      .initContent()
      .add("15/03/2009", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
      ...
      .add("15/02/2009", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
      ...
      .add("15/01/2009", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
  ...
  public void testChangeDayChangeTransactionFromPlannedToRealAndViceversaForNotImportedAccount() throws Exception {
    ...
    transactions
      .showPlannedTransactions()
      .initContent()
      .add("15/10/2008", TransactionType.PLANNED, "Planned: CAF", "", 100.00, "CAF")
      .add("15/09/2008", TransactionType.PLANNED, "Planned: CAF", "", 100.00, "CAF")
    ...
    transactions
      .showPlannedTransactions()
      .initContent()
      .add("15/11/2008", TransactionType.PLANNED, "Planned: CAF", "", 100.00, "CAF")
      .add("15/10/2008", TransactionType.PLANNED, "Planned: CAF", "", 100.00, "CAF")
      .add("15/09/2008", TransactionType.VIREMENT, "Planned: CAF", "", 100.00, "CAF")
      .add("05/08/2008", TransactionType.VIREMENT, "CAF", "", 100.00, "CAF")
      .check();
  }
  ...
  public void testSavingsSeries() throws Exception {
    ...
    transactions
      .showPlannedTransactions()
      .initContent()
      .add("15/10/2008", TransactionType.PLANNED, "Planned: CAF", "", 300.00, "CAF")
      .add("15/09/2008", TransactionType.PLANNED, "Planned: CAF", "", 300.00, "CAF")
