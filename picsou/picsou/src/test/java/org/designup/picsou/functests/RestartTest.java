...
public class RestartTest extends LoggedInFunctionalTestCase {
  ...
  public void testSeries() throws Exception {
    ...
    transactions
      ...
      .initContent()
      .add("30/09/2008", TransactionType.PLANNED, "Planned: Salary", "", 1000.00, "Salary")
  ...
  public void testRestartAfterCurrentMonthChanged() throws Exception {
    ...
    transactions
      .showPlannedTransactions()
      .initContent()
      .add("31/10/2008", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
      .add("08/10/2008", TransactionType.PLANNED, "Planned: Course", "", -400.00, "Course")
      .add("08/10/2008", TransactionType.PLANNED, "Planned: End date", "", -300.00, "End date")
      .add("08/10/2008", TransactionType.PLANNED, "Planned: Begin and end date", "", -200.00, "Begin and end date")
      .add("08/10/2008", TransactionType.PLANNED, "Planned: Begin date", "", -100.00, "Begin date")
      .add("30/09/2008", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
      .add("08/09/2008", TransactionType.PLANNED, "Planned: Course", "", -400.00, "Course")
      .add("08/09/2008", TransactionType.PLANNED, "Planned: End date", "", -300.00, "End date")
      .add("08/09/2008", TransactionType.PLANNED, "Planned: Begin and end date", "", -200.00, "Begin and end date")
      .add("08/09/2008", TransactionType.PLANNED, "Planned: Begin date", "", -100.00, "Begin date")
    ...
    transactions
      .showPlannedTransactions()
      .initContent()
      .add("30/11/2008", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
      .add("08/11/2008", TransactionType.PLANNED, "Planned: Course", "", -400.00, "Course")
      .add("08/11/2008", TransactionType.PLANNED, "Planned: End date", "", -300.00, "End date")
      .add("08/11/2008", TransactionType.PLANNED, "Planned: Begin and end date", "", -200.00, "Begin and end date")
      .add("08/11/2008", TransactionType.PLANNED, "Planned: Begin date", "", -100.00, "Begin date")
      .add("31/10/2008", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
      .add("08/10/2008", TransactionType.PLANNED, "Planned: Course", "", -400.00, "Course")
      .add("08/10/2008", TransactionType.PLANNED, "Planned: End date", "", -300.00, "End date")
      .add("08/10/2008", TransactionType.PLANNED, "Planned: Begin and end date", "", -200.00, "Begin and end date")
    ...
    transactions
      .showPlannedTransactions()
      .initContent()
      .add("31/12/2008", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
      .add("08/12/2008", TransactionType.PLANNED, "Planned: Course", "", -400.00, "Course")
      .add("08/12/2008", TransactionType.PLANNED, "Planned: End date", "", -300.00, "End date")
      .add("08/12/2008", TransactionType.PLANNED, "Planned: Begin and end date", "", -200.00, "Begin and end date")
      .add("08/12/2008", TransactionType.PLANNED, "Planned: Begin date", "", -100.00, "Begin date")
      .add("30/11/2008", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
      .add("08/11/2008", TransactionType.PLANNED, "Planned: Course", "", -400.00, "Course")
      .add("08/11/2008", TransactionType.PLANNED, "Planned: End date", "", -300.00, "End date")
      .add("08/11/2008", TransactionType.PLANNED, "Planned: Begin and end date", "", -200.00, "Begin and end date")
    ...
    transactions
      .showPlannedTransactions()
      .initContent()
      .add("31/03/2009", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
      .add("08/03/2009", TransactionType.PLANNED, "Planned: Course", "", -400.00, "Course")
      .add("08/03/2009", TransactionType.PLANNED, "Planned: Begin date", "", -100.00, "Begin date")
      .add("28/02/2009", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
      .add("08/02/2009", TransactionType.PLANNED, "Planned: Course", "", -400.00, "Course")
      .add("08/02/2009", TransactionType.PLANNED, "Planned: Begin date", "", -100.00, "Begin date")
      .add("31/01/2009", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
      .add("08/01/2009", TransactionType.PLANNED, "Planned: Course", "", -400.00, "Course")
      .add("08/01/2009", TransactionType.PLANNED, "Planned: Begin and end date", "", -200.00, "Begin and end date")
      .add("08/01/2009", TransactionType.PLANNED, "Planned: Begin date", "", -100.00, "Begin date")
      .add("31/12/2008", TransactionType.PLANNED, "Planned: Salaire", "", 1000.00, "Salaire")
      .add("08/12/2008", TransactionType.PLANNED, "Planned: Course", "", -400.00, "Course")
      .add("08/12/2008", TransactionType.PLANNED, "Planned: End date", "", -300.00, "End date")
      .add("08/12/2008", TransactionType.PLANNED, "Planned: Begin and end date", "", -200.00, "Begin and end date")
  ...
  public void testChangeDayChangeTransactionFromPlannedToRealAndViceversaForNotImportedAccount() throws Exception {
    ...
    transactions
      .showPlannedTransactions()
      .initContent()
      .add("08/10/2008", TransactionType.PLANNED, "Planned: CAF", "", 100.00, "CAF")
      .add("08/09/2008", TransactionType.PLANNED, "Planned: CAF", "", 100.00, "CAF")
    ...
    transactions
      .showPlannedTransactions()
      .initContent()
      .add("08/11/2008", TransactionType.PLANNED, "Planned: CAF", "", 100.00, "CAF")
      .add("08/10/2008", TransactionType.PLANNED, "Planned: CAF", "", 100.00, "CAF")
      .add("08/09/2008", TransactionType.VIREMENT, "Planned: CAF", "", 100.00, "CAF")
      .add("05/08/2008", TransactionType.VIREMENT, "CAF", "", 100.00, "CAF")
      .check();
  }
  ...
  public void testSavingsSeries() throws Exception {
    ...
    transactions
      .showPlannedTransactions()
      .initContent()
      .add("08/10/2008", TransactionType.PLANNED, "Planned: CAF", "", 300.00, "CAF")
      .add("08/09/2008", TransactionType.PLANNED, "Planned: CAF", "", 300.00, "CAF")
