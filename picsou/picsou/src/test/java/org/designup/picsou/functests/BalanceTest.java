...
public class BalanceTest extends LoggedInFunctionalTestCase {
  ...
  public void testBalanceWithManualTransactionInTheFuture() throws Exception {
    ...
    transactions
      ...
      .initAmountContent()
      .add("08/08/2009", "Planned: Courses", -10.00, "Courses", -159.60, "Main accounts")
      .add("08/08/2009", "Planned: Tel", -29.90, "Tel", -149.60, "Main accounts")
      .add("08/07/2009", "Planned: Tel", -29.90, "Tel", -119.70, "Main accounts")
      .add("05/07/2009", "PROV", -10.00, "Courses", -20.00, -89.80, "Manual")
      .add("08/06/2009", "Planned: Courses", -10.00, "Courses", -79.80, "Main accounts")
      .add("08/06/2009", "Planned: Tel", -29.90, "Tel", -69.80, "Main accounts")
      .add("22/05/2009", "PROV", -10.00, "Courses", -10.00, -39.90, "Manual")
      .add("15/05/2009", "Planned: Tel", -29.90, "Tel", -29.90, "Main accounts")
