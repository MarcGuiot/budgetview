...
public class TransactionViewTest extends LoggedInFunctionalTestCase {
  ...
  public void testFutureBalance() throws Exception {
    ...
    transactions
      .showPlannedTransactions()
      .initAmountContent()
      .add("08/07/2006", "Planned: Nounou", -100.00, "Nounou", 160.00, "Main accounts")
      .add("08/07/2006", "Planned: Voiture", -70.00, "Voiture", 260.00, "Main accounts")
      .add("08/06/2006", "Planned: Nounou", -100.00, "Nounou", 330.00, "Main accounts")
      .add("08/06/2006", "Planned: Voiture", -70.00, "Voiture", 430.00, "Main accounts")
  ...
  public void testToggleShowPlannedTransactions() throws Exception {
    ...
    transactions.initContent()
      .add("08/07/2006", TransactionType.PLANNED, "Planned: Nounou", "", -100.00, "Nounou")
      .add("08/07/2006", TransactionType.PLANNED, "Planned: Voiture", "", -70.00, "Voiture")
      .add("08/06/2006", TransactionType.PLANNED, "Planned: Nounou", "", -100.00, "Nounou")
      .add("08/06/2006", TransactionType.PLANNED, "Planned: Voiture", "", -70.00, "Voiture")
      .add("06/05/2006", TransactionType.PRELEVEMENT, "NOUNOU", "nourrice", -100.00, "Nounou")
      .add("03/05/2006", TransactionType.PRELEVEMENT, "PEAGE", "", -30.00)
      .add("02/05/2006", TransactionType.PRELEVEMENT, "SG", "", -200.00)
      .add("01/05/2006", TransactionType.PRELEVEMENT, "ESSENCE", "frais pro", -70.00, "Voiture")
