...
public class SeriesWizardTest extends LoggedInFunctionalTestCase {
  ...
  public void testStandardUsage() throws Exception {
    ...
    transactions.initContent()
      .add("31/08/2008", TransactionType.PLANNED, "Planned: Regular savings", "", -200.00, "Regular savings", MasterCategory.SAVINGS)
      .add("31/08/2008", TransactionType.PLANNED, "Planned: Groceries", "", -40.00, "Groceries", MasterCategory.FOOD)
      .add("31/08/2008", TransactionType.PLANNED, "Planned: Cell phone 1", "", -50.00, "Cell phone 1", MasterCategory.TELECOMS)
      .add("31/08/2008", TransactionType.PLANNED, "Planned: Rent", "", -1000.00, "Rent", "Rent")
      .add("31/08/2008", TransactionType.PLANNED, "Planned: Income 1", "", 3000.00, "Income 1", MasterCategory.INCOME)
      .add("31/07/2008", TransactionType.PLANNED, "Planned: Rent", "", -1000.00, "Rent", "Rent")
      .add("31/07/2008", TransactionType.PLANNED, "Planned: Income 1", "", 3000.00, "Income 1", MasterCategory.INCOME)
