...
//        System.out.println("Starting " + this.getName());
    ...
    public void _testSessionAbort() throws Exception {
    ...
    public void _testSessionFailResponse() throws Exception {
        scri = new StubbornClientReceiverImpl(network, "localhost", 9876, client);
        startSession(0);
    ...
    public void _testFailAfterSessionEstablished() throws Exception {
        scri = new StubbornClientReceiverImpl(network, "localhost", 9876, client);
        establishSession(0);
        Thread.yield();
        provider.failReadFromNetwork();
    ...
    public void _testSendIOException() throws Exception {
        scri = new StubbornClientReceiverImpl(network, "localhost", 9876, client);
        Thread.yield();
