...
//        Network oldNetwork = setNetworkToTest();
    ...
    public void _testMessageSendBothWays() throws Exception {
        network.startService(mockService,port);
        client1.connect(port);
        Server server = new Server(1, mockService);
        server.send(testObject1);
    ...
    public synchronized void _test2Clients() throws Exception {
//        port++; 
        network.startService(mockService,port);
        client1.connect(port);
    ...
    public void _test2Services() throws Exception {
        network.startService(mockService,port);
    ...
    public void _testRestartService() throws Exception {
        _testMessageSendBothWays();
        tearDown();
        mockService.reset();
        _testMessageSendBothWays();
    }
