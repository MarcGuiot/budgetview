...
public class GlobLabelViewTest extends GuiComponentTestCase {
  private Glob glob1;
  private Glob glob2;
  ...
  private TextBox init(final GlobRepository repository) {
    TextBox textBox = new TextBox(
      GlobLabelView.init(DummyObject.TYPE, repository, directory, new GlobLabelView.Stringifier() {
