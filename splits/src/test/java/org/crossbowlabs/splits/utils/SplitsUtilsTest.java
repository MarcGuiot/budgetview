...
public class SplitsUtilsTest extends TestCase {
  ...
  public void testIntParsingErrors() throws Exception {
    ...
    checkIntParsingError(getClass().getName() + ".DUMMY_FIELD_PRIVATE",
                         "Field 'DUMMY_FIELD_PRIVATE' not found in class: org.crossbowlabs.splits.utils.SplitsUtilsTest");
    checkIntParsingError(getClass().getName() + ".DUMMY_FIELD_STRING",
                         "Field 'DUMMY_FIELD_STRING' in class 'org.crossbowlabs.splits.utils.SplitsUtilsTest' is not an integer");
    checkIntParsingError(getClass().getName() + ".DUMMY_FIELD_NOT_SET",
                         "Field 'DUMMY_FIELD_NOT_SET' in class 'org.crossbowlabs.splits.utils.SplitsUtilsTest' is not set");
  }
