...
public class CollapseSelectionAction extends SingleSelectionAction {
  private TableExpansionModel expansionModel;

  public CollapseSelectionAction(TableExpansionModel expansionModel, GlobRepository repository, Directory directory) {
