package com.budgetview.desktop.projects.upgrade;
...
import com.budgetview.desktop.upgrade.triggers.BindTransactionsToSeries;
import com.budgetview.desktop.upgrade.triggers.PostProcessor;
...
import static com.budgetview.model.ProjectItemType.isTransfer;
    ...
    postProcessor.add(new PostProcessor.Functor() {
      public void apply(GlobRepository repository) {
        for (Glob stat : repository.getAll(SeriesStat.TYPE,
                                           and(GlobMatchers.fieldEquals(SeriesStat.TARGET_TYPE, SeriesType.SERIES.getId()),
