...
import com.budgetview.desktop.time.mousestates.MouseState;
import com.budgetview.desktop.time.mousestates.ReleasedMouseState;
...
import com.budgetview.desktop.time.selectable.TransformationAdapter;
import com.budgetview.desktop.time.tooltip.TimeViewMouseHandler;
import com.budgetview.desktop.time.tooltip.TimeViewTooltipHandler;
import com.budgetview.desktop.time.utils.TimeViewColors;
...
public class TimeViewPanel extends JPanel implements MouseListener, MouseMotionListener,
  ...
  public Double getMinPosition(int monthId) {
    Glob balance = repository.find(Key.create(AccountStat.MONTH, monthId,
                                              AccountStat.ACCOUNT, Account.MAIN_SUMMARY_ACCOUNT_ID));
    if (balance == null) {
      return 0.0;
    }
    return balance.get(AccountStat.MIN_POSITION, 0.);
  }
