...
public class AppPaths {
  ...
  public static String getDefaultDataPath() {
    if (System.getProperty(Application.LOCAL_DATA_PATH_PROPERTY) != null) {
      return Application.getSystemValue(Application.LOCAL_DATA_PATH_PROPERTY, System.getProperty("user.home") + "/.budgetview");
    }
    if (System.getProperty(Application.LOCAL_PREVAYLER_PATH_PROPERTY) != null) {
      return Application.getSystemValue(Application.LOCAL_PREVAYLER_PATH_PROPERTY, System.getProperty("user.home") + "/.budgetview");
    }
  ...
  public static String getCodePath() {
    if (System.getProperty(Application.LOCAL_CODE_PROPERTY) == null) {
      return getDefaultDataPath();
    }
    return Application.getSystemValue(Application.LOCAL_CODE_PROPERTY, System.getProperty("user.home") + "/.budgetview");
  }
