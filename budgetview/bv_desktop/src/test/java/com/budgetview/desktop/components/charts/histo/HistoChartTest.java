...
import com.budgetview.desktop.components.charts.histo.line.HistoLinePainter;
...
public class HistoChartTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    chart = new HistoChart(new HistoChartConfig(true, true, false, true, true, true, false, true, true, false), new HistoChartColors("histo", directory));
